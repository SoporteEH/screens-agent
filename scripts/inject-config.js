...
// Theme injection: written to theme-overrides.css (loaded after theme.css) so the
// per-theme palette wins the cascade without wiping the structural variables
// (radii, shadows, backdrop, elevated backgrounds) that only theme.css defines.
